...
/***/ function(module, exports, __webpack_require__) {
	...
	var $=__webpack_require__(2);window.jQuery=$; // Loading foundation from node
	var foundation=__webpack_require__(5);var foundationMediaQuery=__webpack_require__(6);var foundationKeyboard=__webpack_require__(7);var foundationBox=__webpack_require__(8);var foundationTriggers=__webpack_require__(9);var foundationDropdown=__webpack_require__(10);var foundationAccordion=__webpack_require__(11);var foundationReveal=__webpack_require__(12);var foundationAbide=__webpack_require__(13);var foundationTooltip=__webpack_require__(14); //require('smoothstate/jquery.smoothState.min.js');
	// var smoothState = require('./jquery.smoothState.min.js');
	window.foundation=foundation; // console.log($);
	// $('h1').fadeOut(2000);
	...
	$(document).ready(function(){ //console.log('Script kiddies of the world unite.')
	$(document).foundation();$("body").on("click",".toggler",function(){$(".toggled").toggle(); /*shows or hides #box*/});});
