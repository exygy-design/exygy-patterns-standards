...
/***/ function(module, exports, __webpack_require__) {
	...
	var foundationAccordion = __webpack_require__(6);
	var foundationReveal = __webpack_require__(7);
	var foundationAbide = __webpack_require__(8);
	var foundationTooltip = __webpack_require__(9);
...
/***/ function(module, exports) {
	...
	!(function (e, n, t) {
	  function o(e, n) {
	    ...
	    var e, n, t, r, s, i, a;for (var l in g) if (g.hasOwnProperty(l)) {
	      if ((e = [], n = g[l], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length))) for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());for (r = o(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++) i = e[s], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = r : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = r), w.push((r ? "" : "no-") + a.join("-"));
	    }
	  }function s(e) {
	    var n = _.className,
	    ...
	    var s,
	        ...
	        c = "modernizr",
	        d = i("div"),
	        p = a();if (parseInt(o, 10)) for (; o--;) f = i("div"), f.id = r ? r[o] : c + (o + 1), d.appendChild(f);return s = i("style"), s.type = "text/css", s.id = "s" + c, (p.fake ? p : d).appendChild(s), p.appendChild(d), s.styleSheet ? s.styleSheet.cssText = e : s.appendChild(n.createTextNode(e)), d.id = c, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = _.style.overflow, _.style.overflow = "hidden", _.appendChild(p)), l = t(d, e), p.fake ? (p.parentNode.removeChild(p), _.style.overflow = u, _.offsetHeight) : d.parentNode.removeChild(d), !!l;
	  }function f(e, n) {
	    return !! ~("" + e).indexOf(n);
	  }function u(e) {
	    ...
	    var r = n.length;if ("CSS" in e && "supports" in e.CSS) {
	      for (; r--;) if (e.CSS.supports(u(n[r]), o)) return !0;return !1;
	    }if ("CSSSupportsRule" in e) {
	      for (var s = []; r--;) s.push("(" + u(n[r]) + ":" + o + ")");return s = s.join(" or "), l("@supports (" + s + ") { #modernizr { position: absolute; } }", function (e) {
	    ...
	    function a() {
	      ...
	      var l = c(e, r);if (!o(l, "undefined")) return l;
	    }for (var u, p, m, h, v, y = ["modernizr", "tspan"]; !E.style;) u = !0, E.modElem = i(y.shift()), E.style = E.modElem.style;for (m = e.length, p = 0; m > p; p++) if ((h = e[p], v = E.style[h], f(h, "-") && (h = d(h)), E.style[h] !== t)) {
	      if (s || o(r, "undefined")) return a(), "pfx" == n ? h : !0;try {
	        E.style[h] = r;
	      } catch (g) {}if (E.style[h] != v) return a(), "pfx" == n ? h : !0;
	    }return a(), !1;
	  }function m(e, n) {
	    return function () {
	    ...
	    var r;for (var s in e) if (e[s] in n) return t === !1 ? e[s] : (r = n[e[s]], o(r, "function") ? m(r, t || n) : r);return !1;
	  }function v(e, n, t, r, s) {
	    var i = e.charAt(0).toUpperCase() + e.slice(1),
	        a = (e + " " + T.join(i + " ") + i).split(" ");return o(n, "string") || o(n, "undefined") ? p(a, n, r, s) : (a = (e + " " + j.join(i + " ") + i).split(" "), h(a, n, t));
	  }function y(e, n, o) {
	    return v(e, t, t, n, o);
	  }var g = [],
	      ...
	      S = C._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];C._prefixes = S;var b = C.testStyles = l;Modernizr.addTest("touchevents", function () {
	    var t;if ("ontouchstart" in e || e.DocumentTouch && n instanceof DocumentTouch) t = !0;else {
	      var o = ["@media (", S.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");b(o, function (e) {
	        t = 9 === e.offsetTop;
	      });
	    }return t;
	    ...
	    delete E.style;
	  });var j = C._config.usePrefixes ? z.toLowerCase().split(" ") : [];C._domPrefixes = j, C.testAllProps = v, C.testAllProps = y, Modernizr.addTest("csstransitions", y("transition", "all", !0)), r(), s(w), delete C.addTest, delete C.addAsyncTest;for (var N = 0; N < Modernizr._q.length; N++) Modernizr._q[N]();e.Modernizr = Modernizr;
	})(window, document);
